...
const ContactUs = () => {
  return (
    <>
      ...
      <div className="max-w-[1056px] w-full mx-auto px-3 pb-12">
        <h2 className="text-[#22343D] text-center font-poppins text-[22px] sm:text-[30px] mt-[30px] font-bold">
          Contact <span className="text-[#FF725E]">& Find us</span>
        </h2>
        <div className="flex justify-center">
          <Lineicon />
        </div>
        <div className="flex w-full gap-x-1 rounded-[10px] mt-[52px] md:flex-row flex-col max-md:items-center max-md:gap-[30px]">
          <div className="p-[30px] bg-[#FF725E] max-w-[451px] w-full flex flex-col gap-[30px] max-md:rounded-[10px]  md:rounded-l-[10px]">
            <h3 className="text-[#22343D] font-poppins text-[25px] md:text-[30px] font-bold uppercase">
              Contact Info
            </h3>
            <p className="text-[#22343D] font-poppins text-[16px] md:text-[20px] font-medium ">
              You can always reach us via following contact details. We will
              give our best to reach you as possible.
            </p>
            <div className="flex gap-[25px]">
              <p className="text-[#22343D] font-poppins text-[16px] md:text-[20px] font-normal ">
                Phone:
              </p>
              <div>
                <Link href="">
                  <p className="text-[rgba(255,255,255,0.80)] hover:text-[#22343D] font-poppins text-[16px] md:text-[20px] font-semibold leading-[33px] ">
                    +234 805 029 1265{" "}
                  </p>
                </Link>
                <Link href="">
            ...
            <div className="flex gap-[32px]">
              ...
              <div>
                <Link href="">
                  <p className="text-[rgba(255,255,255,0.80)] hover:text-[#22343D] font-poppins text-[16px] sm:text-[20px] font-semibold leading-[33px] ">
                    Info20@gmail.com
                  </p>
                </Link>
            ...
            <div className="flex gap-1">
              ...
              <div>
                <p className="text-[rgba(255,255,255,0.80)] font-poppins text-[16px] md:text-[20px] font-semibold leading-[33px] ">
                  4 law castle agbole aro opp. fidelity bank omida, abeokuta.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full max-md:rounded-[10px] md:rounded-r-[10px] max-md:max-w-[451px] max-md:h-[400px]">
            <iframe
        ...
        <h2 className="text-[#22343D] text-center font-poppins text-[22px] sm:text-[30px] mt-[46px] font-bold">
